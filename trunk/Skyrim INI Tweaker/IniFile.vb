...
Public Class IniFile
    ...
    Public Sub Load(ByVal sFileName As String, Optional ByVal bMerge As Boolean = False)
        ...
        While Not oReader.EndOfStream
            Dim line As String = oReader.ReadLine.Replace(" ", "_")
        ...
        For Each s As IniSection In Sections
            ...
            For Each k As IniSection.IniKey In s.Keys
                If k.Value <> String.Empty Then
                    Trace.WriteLine(String.Format("Writing Key: {0}={1}", k.Name.Replace("_", " "), k.Value.Replace("_", " ")))
                    oWriter.WriteLine(String.Format("{0}={1}", k.Name.Replace("_", " "), k.Value.Replace("_", " ")))
                Else
                    Trace.WriteLine(String.Format("Writing Key: {0}", k.Name.Replace("_", " ")))
                    oWriter.WriteLine(String.Format("{0}", k.Name.Replace("_", " ")))
                End If
            Next
        Next
        oWriter.Close()
    ...
    Public Function GetKeyValue(ByVal sSection As String, ByVal sKey As String, Optional ByVal sType As String = "") As String
    ...
    Public Sub SetKeyValue(ByVal sSection As String, ByVal sKey As String, ByVal sValue As String)
